...
- Blood group system/reported locus: RBCeq2 emits one genotype+phenotype call per gene/locus. The v2.4.4 db has 88 systems, 35 of them HPA platelet systems, and 86 once RHD and RHCE are set aside; v2.4.1 had 48, before HPA was added. These map to ISBT blood group systems but not 1:1, one system can involve several genes, and some reported loci are related transporters/regulators.
